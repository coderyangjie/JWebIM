...
;(function($){
    ...
    $.fn.extend({
        ...
        JWebIM: function(options) {
            ...
            //合并默认配置项和自定义配置项的值
            var options =  $.extend(defaults, options); //合并两个对象

            //核心方法，通过return this.each()获得返回的jquery对象，可以进行链式调用。
            return this.each(function() {
                //显示fn_imbar
                $("body").append('<div id="fn_imbar" class="im_login">' +
                    '<span>在线交流工具<b title="3条未读消息">3</b></span>' +
                    '</div>' +
                    '<div id="fn_imbox"></div>');
                ...
                $("#fn_imbar.im_login").click(function(){
                    ...
                    /************************加载 联系人面板 start ****************************/
                    //ajax请求联系人面板页面
                    $.ajax({url:"pages/im_contact.html",dataType:"html",success:loginIM,error:loginError});
                    //请求成功回调方法
                    function loginIM(data){
                        ...
                        $("#fn_imbox .im_top a.modify").click(function(){
                            $.ajax({url:"pages/msgbox.html",dataType:"html",success:function(data){

                                art.dialog({title:"消息盒子",padding:0,content:data,ok:function(){}});
                                $("#im_msgboxs").slimScroll();
                                $("dl.im_msgbox dd.im_msginfo").click(function(){
                                    var uid=$(this).attr("uid");
                                    $.ajax({url:"pages/im_window.html",dataType:"html",success:function(data){
                                        var uid=$(this).attr("uid");
                        ...
                        $("#fn_imbox .im_contents h4").click(function(){
                            ...
                            $(this).next(".im_group_contacts").show().slimScroll();//显示滚动条
                        });
                        //好友搜索
                        ...
                        $("#fn_imbox .im_bottombar li.smssub").click(function(){
                            art.art("您还没有开通短信小秘书功能，请先开通。 <a href='#' target='_blank'>开通&gt;</a> ");
                        });
                        ...
                        $("#fn_imbox .im_bottombar li.backlist").click(function(){
                            $.ajax({url:"pages/friends.html",dataType:"html",success:function(data){
                                art.dialog({title:"查看黑名单",padding:0,content:data,ok:function(){

                                }});
                                $(".im_friendsbox").slimScroll();
                        ...
                        function loginTimeOut(){
                            $.ajax({url:"pages/login.html",dataType:"html",success:function(data){
                    ...
                    function Friends(){
                        ...
                        //WebIM小秘书
                        if(options.showSecretary){ //如果设置了显示小秘书，即showSecretary=true
                            $("#imFriends").append('<div class="im_contact online"  uid=""><i><img src="images/img/avatar_s-sys.png" width="30" height="30" /><sup></sup></i><span>WebIM小秘书</span><a href="#" target="_blank"></a></div>');
                        }
                        $.getJSON("data/friends.json",function(json){
                            ...
                            var Scroll=function(){$(".im_contacts").slimScroll();}//显示滚动条
                            Scroll();
                    ...
                    function operatewindow(){
                        ...
                        $(".im_face").click(function(){
                            ...
                            _this.show();
                            $.ajax({url:"pages/im_face.html",success:function(data){
                        ...
                        $(".im_product").click(function(){
                            art.prompt('请输入您的在凡纳网的产品网址 (<a href="javascript:;" title="① 打开您想要发送的的产品页面，\n② 复制地址栏里的地址粘贴到下面文本框即可。\n注意：必须为凡纳网的产品地址">?</a>)：', function (value) {
                                ...
                                if(fnURL.test(value)==true){
                                    ...
                                    /*************************加载产品信息************************/
                                    $.ajax({url:"pages/product.html?pid="+pid,dataType:"html",success:function(data){
                                        ...
                                        $(".im_chats").slimScroll({Bar:{Pos:"bottom"}});
                                        ...
                                        $("a.im_product_share").click(function(){
                                            $.ajax({url:"pages/share.html",dataType:"html",success:function(data){
                        ...
                        $("a.im_moreoperates").click(function(){
                            ...
                            $("a.im_areport").click(function(){
                                art.confirm("您确定要举报该好友吗？",function(){
                                    art.dialog({title:"请填写举报原因：",padding:"0",content:"<iframe width='400' scrolling='no' height='215' src='pages/report.html' frameborder='0'></iframe> ",ok:function(){
                                        //提交数据
                        ...
                        $(".im_contactcompany").click(function(){
                            $.ajax({url:"pages/companyinfo.html?"+$(this).attr("cid"),dataType:"html",success:function(data){
                                $(".im_contactinfos").html(data).slimScroll();
                    ...
                    function urlFilter(){
                        ...
                        try{
                            ...
                            for(var i=0;i<urls.length;i++){
                                msgRecord.html(msgRecord.html().replace(urls[i], '<a class="fn_url" href="'+urls[i]+'" target="_blank" title="JWebIM官方网站，没有安全风险">'+urls[i]+'</a>'));
                            }
                        }catch(ex){}
                    }
                    /****网址过滤 end ****/
                    /****修改资料 start ****/
                    function modify(){
                        $.ajax({url:"pages/set.html",dataType:"html",success:function(data){
                    ...
                    /****用户名片 start ****/
                    function card(uid){
                        $.ajax({url:"pages/card.html?uid="+uid,dataType:"html",success:function(data){
                ...
                //配置autoLogin=true为自动登录或配置登录后打开新聊天窗口时，进行WebIM登录
                if(options.autoLogin||options.defaultWindow!=""){
                    $("#fn_imbar.im_login").click();
                }
